...
/**
 * Converts {@code LocalDate} (Java) ↔ {@code Date} (SQL)
 *
...
public final class LocalDateAttributeConverter implements AttributeConverter<LocalDate, Date> {
    ...
    public final Date convertToDatabaseColumn(final LocalDate value) {
        return value == null ? null : Conversions.asSqlDate(value);
    }

    @Override
    public final LocalDate convertToEntityAttribute(final Date value) {
        return value == null ? null : Conversions.asLocalDate(value);
    }
}
